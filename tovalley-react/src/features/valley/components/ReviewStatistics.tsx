...
const ReviewStatistics = React.memo(
  ({ reviewRespDto }: { reviewRespDto: ReviewRespDto }) => {
      ...
      <div className={styles.reviewStatistics}>
        <div className={styles.totalRating}>
          ...
          <div className={styles.ratingNum}>
            <span>
              {valley ? valley.review : reviewRespDto.waterPlaceRating}
            </span>
            <span> / 5</span>
          </div>
        </div>
  ...
  (prevProps, nextProps) =>
    JSON.stringify(prevProps.reviewRespDto) ===
    JSON.stringify(nextProps.reviewRespDto)
)
