...
const RescueTable = React.memo(
  ...
  (prevProps, nextProps) =>
    JSON.stringify(prevProps.rescueSupplies) ===
      JSON.stringify(nextProps.rescueSupplies) &&
    JSON.stringify(prevProps.dangerSignboardsNum) ===
      JSON.stringify(nextProps.dangerSignboardsNum)
)
